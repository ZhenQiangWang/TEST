...
public class SayHelloResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the _return value for this SayHelloResponse.
     * 
     * @return _return
     */
    ...
    /**
     * Sets the _return value for this SayHelloResponse.
     * 
     * @param _return
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.e1.cy.com", "sayHelloResponse"));
