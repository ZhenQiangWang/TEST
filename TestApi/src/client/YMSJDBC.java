...
public class YMSJDBC {
    private static String USERNAMR = "yms_eda";
    private static String PASSWORD = "yms_eda";
    private static String DRVIER = "oracle.jdbc.OracleDriver";
    private static String URL = "jdbc:oracle:thin:@192.168.68.135:1521:EDADB1";
