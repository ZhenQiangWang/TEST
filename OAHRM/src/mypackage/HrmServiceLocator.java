...
public class HrmServiceLocator extends org.apache.axis.client.Service implements mypackage.HrmService {
    ...
    private java.lang.String HrmServiceHttpPort_address = "http://192.168.68.172:8008/services/HrmService";
    ...
    public mypackage.HrmServicePortType getHrmServiceHttpPort() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.HrmServicePortType getHrmServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.HrmServiceHttpBindingStub _stub = new mypackage.HrmServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.HrmServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.HrmServiceHttpBindingStub _stub = new mypackage.HrmServiceHttpBindingStub(new java.net.URL(HrmServiceHttpPort_address), this);
                _stub.setPortName(getHrmServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
