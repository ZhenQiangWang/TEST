...
public class WorkflowMainTableInfo  implements java.io.Serializable {
    private mypackage.WorkflowRequestTableRecord[] requestRecords;
    ...
    public WorkflowMainTableInfo(
           mypackage.WorkflowRequestTableRecord[] requestRecords,
     ...
     */
    public mypackage.WorkflowRequestTableRecord[] getRequestRecords() {
        return requestRecords;
    }
     ...
     */
    public void setRequestRecords(mypackage.WorkflowRequestTableRecord[] requestRecords) {
        this.requestRecords = requestRecords;
    }
