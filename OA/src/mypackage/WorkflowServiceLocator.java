...
public class WorkflowServiceLocator extends org.apache.axis.client.Service implements mypackage.WorkflowService {
    ...
    private java.lang.String WorkflowServiceHttpPort_address = "http://192.168.68.172:8008/services/WorkflowService";
    ...
    public mypackage.WorkflowServicePortType getWorkflowServiceHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WorkflowServiceHttpBindingStub _stub = new mypackage.WorkflowServiceHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.WorkflowServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WorkflowServiceHttpBindingStub _stub = new mypackage.WorkflowServiceHttpBindingStub(new java.net.URL(WorkflowServiceHttpPort_address), this);
                _stub.setPortName(getWorkflowServiceHttpPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.services.weaver.com.cn", "WorkflowService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.services.weaver.com.cn", "WorkflowServiceHttpPort"));
        }
